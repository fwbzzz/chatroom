...
<#--EE大量用到-->
<#--鼻祖都是Jsp-->
<#--要使用FreeMarker后端必须加载模板引擎-->
<#--需要配置一下tomcat加载ftl页面的路径-->
<#--通过WebListener搞定-->
<#--当项目启动的时候，监听器就启动了这样可以将一些全局的配置扔进去，这样各个Servlet都可以使用-->
<#--*/-->
...
<script type="text/javascript">
    ...
    if ('WebSocket' in window) {
        ...
        webSocket = new WebSocket('ws://127.0.0.1:80/websocket?username=' + '${username}');
    } else {
